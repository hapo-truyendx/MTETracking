...
export function getSellNft(id, price){
    return apiClient.post(`${ApiConfig.BASE_URL}${ApiConfig.LIST_NFT}/${id}/sell`, {
        price: price,
    })
}

export function getBuyNft(id){
    return apiClient.get(`${ApiConfig.BASE_URL}${ApiConfig.LIST_NFT}/${id}/buy`)
}

export function getCancelBuyNft(id){
    return apiClient.get(`${ApiConfig.BASE_URL}${ApiConfig.LIST_NFT}/${id}/cancel`)
}
